...
// variables, poco flexbox fiable), así que todo va con estilos en línea
// y tablas para máxima compatibilidad (Gmail, Outlook, Apple Mail...).
...
<body style="margin:0; padding:0; background-color:${BONE}; font-family: Georgia, 'Times New Roman', serif;">
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border:1px solid rgba(36,29,18,0.1);">
          ...
          <tr>
            <td style="background-color:${CHARCOAL}; padding:28px 32px; text-align:center;">
              ...
              <div style="color:${GOLD}; font-family: Arial, sans-serif; font-size:10px; letter-spacing:2px; text-transform:uppercase; margin-top:2px;">
                Centro de Estética
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 32px;">
              <h1 style="margin:0 0 16px; font-family: Georgia, serif; font-size:22px; color:${INK};">
                ${heading}
              </h1>
              <div style="font-family: Arial, sans-serif; font-size:14px; line-height:1.6; color:${INK};">
                ${bodyHtml}
              </div>
              ...
              ${
                ...
                <tr>
                  <td style="background-color:${GOLD};">
                    <a href="${ctaUrl}" style="display:inline-block; padding:12px 24px; font-family: Arial, sans-serif; font-size:14px; font-weight:bold; color:${CHARCOAL}; text-decoration:none;">
                      ${ctaLabel}
                    </a>
                  </td>
                </tr>
          ...
          <!-- Pie carbón -->
          <tr>
            <td style="background-color:${CHARCOAL}; padding:20px 32px; font-family: Arial, sans-serif; font-size:11px; color:rgba(250,247,241,0.5); text-align:center;">
...
export const emailColors = { CHARCOAL, GOLD, GOLD_DARK, BONE, INK, STONE };
